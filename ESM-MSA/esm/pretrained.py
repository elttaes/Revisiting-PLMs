...
def load_model_and_alphabet_hub(model_name):
    ...
    # model_data = torch.load(f"/esm_1b_only_test/esm-master/pretained_model/esm1b_t33_650M_UR50S.pt", map_location="cpu",)
    # regression_data = torch.load(f"/esm_1b_only_test/esm-master/pretained_model/esm1b_t33_650M_UR50S-contact-regression.pth", map_location="cpu",)
...
def esm1b_load_local_pretrained_model():
    model_data = torch.load(
            f"../esm_pretrained_models/esm1b_t33_650M_UR50S.pt",
            map_location="cpu",
        )
    # load train ContactRegression
    regression_data = torch.load(
            f"../esm_pretrained_models/ContactRegression/esm1b_t33_650M_UR50S-contact-regression.pt",
            map_location="cpu",
        )
    return load_model_and_alphabet_core(model_data, regression_data)

def esm1v_load_local_pretrained_model():
    model_data = torch.load(
            f"../esm_pretrained_models/esm1v_t33_650M_UR90S_1.pt",
            map_location="cpu",
        )
    # load train ContactRegression
    regression_data = torch.load(
            f"../esm_pretrained_models/esm1b_t33_650M_UR50S-contact-regression.pt",
            map_location="cpu",
        )
    return load_model_and_alphabet_core(model_data, regression_data)

def esm_msa_load_local_pretrained_model():
    model_data = torch.load(
            f"../esm_pretrained_models/esm_msa1_t12_100M_UR50S.pt",
            map_location="cpu",
        )
    # load train ContactRegression
    regression_data = torch.load(
            f"../esm_pretrained_models/esm_msa1_t12_100M_UR50S-contact-regression.pt",
            map_location="cpu",
        )
    return load_model_and_alphabet_core(model_data, regression_data)
