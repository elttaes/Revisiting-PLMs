...
import scipy.stats
import numpy as np
from DLG4_RAT_Ranganathan2012 import seq,res2
...
def read_msa(filename: str, nseq: int) -> List[Tuple[str, str]]:
    ...
    msa = [(desc, seq.upper()[:83]) for desc, seq in msa]
    return msa
...
for q in range(len(msa_num)):
    data = [read_msa('/home/my/nips/mutation/mutation_data/msa/DLG4_RAT_Ranganathan2012/bfd_uniclust_hits.a3m', msa_num[q])]
