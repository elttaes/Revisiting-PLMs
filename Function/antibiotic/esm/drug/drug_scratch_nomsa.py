...
if __name__ == '__main__':
    ...
    downstream_model = model.model_down_tape_scratch.ProteinBertForSequenceClassification().cuda()
    ...
    for epoch in range(epochs):
        ...
        if val_acc > best_acc:
            ...
            torch.save(save_data, "./save/downstream/best_drug_scratch_nomsa.pt")
            best_acc = val_acc
